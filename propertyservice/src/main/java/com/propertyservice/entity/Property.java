...
public class Property {
	...
	//CascadeAll: Any action done on Property will also be done on its Rooms.
	//orphanRemoval: If you remove a room from the rooms list of a property, 
	//that room will also be deleted from the database.
